...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained_weights', default='Z:/ibot-main/pth/checkpoint.pth', type=str, help="""Path to pretrained
    ...
    parser.add_argument('--data_path', default='Z:/ibot-main/data/', type=str,
        help='Please specify path to the ImageNet data.')
    parser.add_argument("--out_dim", type=int, default=20, help="out_dim")
