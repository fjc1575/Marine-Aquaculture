...
parser.add_argument('--output_dir', default='./output_0408', type=str, help='output dir')   # 输出路径
parser.add_argument('--max_iterations', type=int,
                    default=30000, help='maximum epoch number to train')
parser.add_argument('--max_epochs', type=int,
                    default=151, help='maximum epoch number to train')
...
if args.dataset == "Synapse":
    args.root_path = os.path.join(args.root_path, "trainl_512_0404")    # npz  trainl_512_0404  trainl_ch
...
if __name__ == "__main__":
    ...
    trainer[dataset_name](args, net, args.output_dir)   # 根据数据集名称获取相应的训练器对象，并调用进行模型训练